...
st.sidebar.image('https://raw.githubusercontent.com/rafaelduria/Machine_Learning_LinearRegression_LogisticRegression_predict_table_fipe_Brazil/blob/main/img_fipe.png')
#titulo
